...
The default template for these emails is the Confirmed Opt In template. You can edit this template from the link:../../core-modules/emails#_email_templates[Email Templates] module, but note that it must contain the Opt In link.
